...
EXECTIMES="14,1000000,6,1000000 31,1000000,9,1000000 68,1000000,18,1000000 126,1000000,28,1000000 189,1000000,51,1000000 95,1000000,23,1000000 21,1000000,7,1000000 40,1000000,10,1000000 136,1000000,21,1000000 294,1000000,47,1000000 21,1000000,6,1000000 43,1000000,9,1000000 100,1000000,19,1000000 133,1000000,25,1000000 267,6,47,1000000"
...
if [ "$UNAME_M" = "aarch64" ]; then
    ...
    taskset -c 4,5,6,7 ./pkshin_detect multicam $MODELFILE gpu $DATADIR sequential multicam_result.json $EXECTIME

    echo "simultaneous" >> result.txt
    taskset -c 4,5,6,7 ./pkshin_detect multicam $MODELFILE gpu $DATADIR simultaneous multicam_result.json $EXECTIME
